...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM freelance LIMIT $start,$limit";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$pro_id    = $row['freelance_id'];
			$pro_cat   = $row['freelance_nom'];
			$pro_brand = $row['freelance_domaine'];
			$pro_title = $row['freelance_phone'];
			$pro_price = $row['freelance_email'];
			$pro_image = $row['freelance_image'];
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								<div class='panel-heading'>$pro_cat</div>
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:160px; height:250px;'/>
								</div>
								<div class='panel-heading'>$pro_brand
								</div>
							</div>
						</div>	
			";
...
// 							echo   
// 								'<input type="hidden" name="return" value="http://localhost/jengu/payment_success.php"/>
// 					                <input type="hidden" name="notify_url" value="http://localhost/jengu/payment_success.php">
// 									<input type="hidden" name="cancel_return" value="http://localhost/jengu/cancel.php"/>
