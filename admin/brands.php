  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_brand_modal" class="btn btn-primary btn-sm">Ajouter Marque</a>
      	</div>
      </div>
        ...
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nom </label>
                <input type="text" name="e_brand_title" class="form-control" autocomplete="off" placeholder="Entrez le nom de la marque">
              </div>
            </div>
