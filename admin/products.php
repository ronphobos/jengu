        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" autocomplete="off" name="product_name" class="form-control" placeholder="Enter Product Name">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" autocomplete="off" name="product_desc" placeholder="Enter product desc"></textarea>
		        	</div>
        		</div>
            <div class="col-12">
              <div class="form-group">
                <label>Qty Produit</label>
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Mot clé Produit <small>(ex: apple, iphone, mobile)</small></label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Enter Product Keywords">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Image Produit<small>(format: jpg, jpeg, png)</small></label>
