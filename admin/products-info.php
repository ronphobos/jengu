        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="product_name" class="form-control" autocomplete="off" placeholder="Enter Product Name">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="product_keywords" autocomplete="off" class="form-control" placeholder="Enter Product Keywords">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
...
<script type="text/javascript" src="./js/info_produits.js"></script>